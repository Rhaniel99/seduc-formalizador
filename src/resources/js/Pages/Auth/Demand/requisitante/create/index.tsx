...
export default function NovaDemanda({ onNavigate }: NovaDemandaProps) {
  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 1) {
      ...
      if (!formData.responsibles || formData.responsibles.length === 0) {
        ...
        formData.responsibles.forEach((r, index) => {
          if (!r.name.trim()) {
            newErrors[`responsibles.${index}.name`] = 'Nome é obrigatório';
          }
          if (!r.registrationNumber.trim()) {
            newErrors[`responsibles.${index}.registrationNumber`] = 'Matrícula é obrigatória';
          }
        });
      }
    }
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label>Responsáveis pela Demanda *</Label>
                      ...
                      >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              value={responsible.registrationNumber}
                              onChange={(e) =>
                                updateResponsible(index, 'registrationNumber', e.target.value)
                              }
